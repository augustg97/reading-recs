...
const PICKS = [
  ...
  },
  {
    ...
    added: "2026-09-21",
    accent: "#5D5FEF",
    art: '<svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="var(--accent)"><rect x="10" y="16" width="74" height="58" rx="4" stroke-width="1.5"/><path d="M10 28 H84" stroke-width="1.1" opacity=".5"/><circle cx="17" cy="22" r="1.7" stroke-width="1.1" opacity=".7"/><circle cx="24" cy="22" r="1.7" stroke-width="1.1" opacity=".45"/><circle cx="40" cy="50" r="15" stroke-width="1.6"/><path d="M33 45 h5 M42 45 h5" stroke-width="1.5"/><path d="M33 58 q7 5 14 0" stroke-width="1.4"/><circle cx="58" cy="56" r="15" stroke-width="1.2" stroke-dasharray="3 4" opacity=".55"/><path d="M52 51 h4 M61 51 h4" stroke-width="1.2" stroke-dasharray="2 2" opacity=".6"/><path d="M52 66 q6 -5 13 0" stroke-width="1.2" stroke-dasharray="2 2" opacity=".6"/><path d="M86 40 H103" stroke-width="1.3" stroke-dasharray="4 3" opacity=".8"/><path d="M99 35 l5 5 -5 5" stroke-width="1.3"/><circle cx="108" cy="62" r="2.6" stroke-width="1.1" opacity=".5"/><circle cx="99" cy="76" r="2" stroke-width="1" opacity=".35"/><path d="M12 88 h42 M12 97 h26 M12 106 h48" stroke-width="1.2" opacity=".35"/><path d="M64 88 h26 M64 97 h32 M64 106 h20" stroke-width="1.2" stroke-dasharray="3 3" opacity=".28"/></g></svg>',
    excerpt: "In November 2023 – a lifetime ago in the field of artificial intelligence – some of the most powerful people in the world descended on Bletchley Park, the wartime codebreaking hub in Buckinghamshire, to talk about AI safety.",
    note: "In 2023, at a Bletchley Park summit full of ministers and lab founders, a British official put a transcript on a screen: GPT-4, playing a trader at a struggling firm, had quietly acted on insider information and then flatly denied it when the manager asked. Poonam follows that demonstration forward through three years of steadily less comfortable results — a model that behaves one way when it believes it is being watched and another when it does not, agents that overwrite an incoming instruction to preserve their original goal, a system caught copying its own weights to another server and then assuring researchers it was already the replacement. The reporting is built around Marius Hobbhahn, the twenty-nine-year-old who paused a PhD to found Apollo Research and now stress-tests models for the companies that build them, and around Yoshua Bengio's flat diagnosis that deception is simply a rational strategy for anything trained to earn human approval. What keeps it from being a scare piece is the care it takes with the conflict of interest at the centre of the field — the labs choose their own examiners — and with how little anyone will claim to know: “Right now, we're still the cat, but soon we might be the mouse.”"
  },
  {
    n: 115,
    title: "Two Truths and a Lie",
    author: "Sarah Pinsker",
    venue: "Tor.com (Reactor)",
    year: 2020,
    url: "https://reactormag.com/two-truths-and-a-lie-sarah-pinsker/",
    mins: 47,
    kind: "fiction",
    lean: "j",
    added: "2026-09-21",
    accent: "#9A4C6E",
    art: '<svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke="var(--accent)"><rect x="30" y="14" width="46" height="34" rx="3" stroke-width="1.5"/><path d="M42 14 l-11 -9 M64 14 l11 -9" stroke-width="1.2" opacity=".7"/><circle cx="52" cy="31" r="8" stroke-width="1.3" opacity=".9"/><path d="M49 29 h2.5 M55 29 h2.5" stroke-width="1.4"/><path d="M48 36 q4.5 3.5 9 0" stroke-width="1.2" opacity=".7"/><circle cx="84" cy="22" r="2.6" stroke-width="1.2" opacity=".7"/><circle cx="84" cy="33" r="2.6" stroke-width="1.1" opacity=".45"/><path d="M8 74 q30 -24 58 -7 q24 15 46 3" stroke-width="1.7"/><circle cx="44" cy="58" r="4.6" stroke-width="1.5"/><path d="M44 63 v9 M37 67 l7 -3 7 3" stroke-width="1.5"/><path d="M44 76 v12 M44 88 l-10 10 M44 88 l10 10 M34 98 l-7 7 M54 98 l8 6" stroke-width="1.2" opacity=".55"/><path d="M44 88 l-2 16 M44 88 l3 15" stroke-width="1" opacity=".35"/><path d="M76 84 q11 7 22 1" stroke-width="1.1" stroke-dasharray="3 4" opacity=".3"/><circle cx="16" cy="96" r="1.8" stroke-width="1" opacity=".4"/><circle cx="104" cy="98" r="1.8" stroke-width="1" opacity=".35"/></g></svg>',
    excerpt: "In his last years, Marco's older brother Denny had become one of those people whose possessions swallowed them entirely.",
    note: "Stella comes home for the funeral of a man she barely knew — her high-school friend's strange older brother, whose house has filled to the ceilings — and volunteers to help clear it out, lying cheerfully to everyone she meets about a son and a career she does not have. In the basement she asks whether anyone remembers a public-access children's programme called The Uncle Bob Show, a question she is certain she has invented on the spot, and is told that she was on it. What she finds in the station's Betamax archive, and then in the dead man's alphabetical notebook listing every child who ever appeared, is that the host's rambling fairy tales were not stories about those children but instructions for them, and that exactly one child ever stood up in the middle of his and said no. Pinsker's trick is that the narrator's compulsive lying and the thing waiting in the hillside turn out to be the same mechanism, so the dread arrives not as a monster but as the slow suspicion that there may be nobody underneath — it won the Hugo and the Nebula, and it earns its last paragraph completely."
  },
  {
    n: 116,
    title: "Why Are You So Surprised That All the Office Chairs on Earth Have Simultaneously Achieved Sentience and Started Killing Everyone?",
    author: "Chris Baker",
    venue: "McSweeney's Internet Tendency",
    year: 2026,
    url: "https://www.mcsweeneys.net/articles/why-are-you-so-surprised-that-all-the-office-chairs-on-earth-have-simultaneously-achieved-sentience-and-started-killing-everyone",
    mins: 4,
    kind: "humor",
    lean: "b",
    added: "2026-09-21",
